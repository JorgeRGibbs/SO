...
{
  printf("\nIngrese numero de filas en A: "); scanf("%d",rowsA);
  printf("\nIngrese numero de columnas en A (filas en B): "); scanf("%d",cA_rB);
  printf("\nIngrese numero de columnas en B: "); scanf("%d",colsB);
  printf("\nIngrese numero de de procesos: "); scanf("%d",procs);
